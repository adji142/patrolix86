  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
          ...
          <div class="col-md-6 col-sm-6 ">
            ...
            <table class="table">
              <tr>
                ...
                <td>:</td>
                <td>
                  <!-- <div id="Tanggal_Detail_IN"></div> -->
                  <input type="hidden" name="idabsen" id="idabsen">
                  <input type="date" name="Tanggal_Detail_IN" id="Tanggal_Detail_IN">
                </td>
              </tr>
              <tr>
                <td>Jam </td>
                <td>:</td>
                <td>
                  <!-- <div id="Jam_Detail_IN"></div> -->
                  <input type="time" name="Jam_Detail_IN" id="Jam_Detail_IN">
                </td>
              </tr>
              <tr>
                <td>Lokasi </td>
          ...
          <div class="col-md-6 col-sm-6 ">
            ...
            <table class="table">
              <tr>
                ...
                <td>:</td>
                <td>
                  <!-- <div id="Tanggal_Detail_OUT"></div> -->
                  <input type="date" name="Tanggal_Detail_OUT" id="Tanggal_Detail_OUT">
                </td>
              </tr>
              <tr>
                <td>Jam </td>
                <td>:</td>
                <td>
                  <!-- <div id="Jam_Detail_OUT"></div> -->
                  <input type="time" name="Jam_Detail_OUT" id="Jam_Detail_OUT">
                </td>
              </tr>
              <tr>
                <td>Lokasi </td>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btnUpdate">Simpan</button>
...
<script type="text/javascript">
  $(function () {
    ...
    $('#btnUpdate').click(function () {
      var TglCheckin = $('#Tanggal_Detail_IN').val() + " " +$('#Jam_Detail_IN').val();
      var TglCheckout = $('#Tanggal_Detail_OUT').val() + " " +$('#Jam_Detail_OUT').val();
      var id = $('#idabsen').val();

      $('#btnUpdate').text('Tunggu Sebentar.....');
      $('#btnUpdate').attr('disabled',true);
      
      $.ajax({
        async:false,
        type: "post",
        url: "<?=base_url()?>C_Absensi/UpdateAbsensi",
        data: {
          'checkindate' : TglCheckin,
          'checkoutdata': TglCheckout,
          'id' : id
        },
        dataType: "json",
        success: function (response) {
          if(response.success == true){
            $('#modal_detail_absen').modal('toggle');
            Swal.fire({
              type: 'success',
              title: 'Horay..',
    ...
    $.ajax({
      ...
      success: function (response) {
        $.each(response.data,function (k,v) {
          ...
          $('#Tanggal_Detail_IN').val(v.oriCheckinDate);
          $('#Jam_Detail_IN').val(v.CheckinTime);
          ...
          $('#Tanggal_Detail_OUT').val(v.oriCheckoutDate);
          $('#Jam_Detail_OUT').val(v.CheckoutTime);
